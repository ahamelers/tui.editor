...
var Paragraph$1 = /** @class */ (function (_super) {
    ...
    Paragraph.prototype.keymaps = function () {
        return {
            'Mod-Tab': this.indent(true)(),
            'Mod-Shift-Tab': this.outdent(true)(),
...
var Table$1 = /** @class */ (function (_super) {
    ...
    Table.prototype.keymaps = function () {
        return {
            ...
            'Mod-Tab': this.moveTableCell(true),
            'Mod-Shift-Tab': this.moveTableCell(false),
        };
    };
    return Table;
}(Mark));
...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.keymaps = function () {
        ...
        return {
            'Mod-Tab': this.moveToCell("right" /* RIGHT */),
            'Mod-Shift-Tab': this.moveToCell("left" /* LEFT */),
